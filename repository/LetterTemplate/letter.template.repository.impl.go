...
func (r *LetterTemplateRepositoryImpl) GetAll() ([]model.LetterTemplate, *helper.ErrorModel) {
...
func (r *LetterTemplateRepositoryImpl) GetByID(id string) (*model.LetterTemplate, *helper.ErrorModel) {
...
func (r *LetterTemplateRepositoryImpl) Update(id string, template model.LetterTemplate) (*model.LetterTemplate, *helper.ErrorModel) {
	existing, errModel := r.GetByID(id)
	if errModel != nil {
		return nil, errModel
	}
...
func (r *LetterTemplateRepositoryImpl) Delete(id string) *helper.ErrorModel {
	existing, errModel := r.GetByID(id)
	if errModel != nil {
		return errModel
	}
